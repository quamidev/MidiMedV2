/**
 * Select component based on Radix UI primitives.
 * Provides accessible dropdown select with custom styling.
 *
...
>(({ className, children, error, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-11 w-full items-center justify-between rounded-lg border border-input bg-background px-4 py-2 text-base shadow-sm transition-all duration-200',
